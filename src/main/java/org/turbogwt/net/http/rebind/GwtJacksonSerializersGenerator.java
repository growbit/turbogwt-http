 ...
 */
public class GwtJacksonSerializersGenerator extends Generator {
    ...
    public String generate(TreeLogger logger, GeneratorContext ctx, String typeName) throws UnableToCompleteException {
        ...
        if (sourceWriter != null) {
            ...
            for (JClassType type : typeOracle.getTypes()) {
                GwtJacksonSerialize annotation = type.getAnnotation(GwtJacksonSerialize.class);
                if (annotation != null) {
    ...
    private String getTypeSimpleName() {
        return "GwtJacksonSerializersImpl";
    }
    ...
    private SourceWriter getSourceWriter(TreeLogger logger, GeneratorContext ctx, JClassType intfType) {
        ...
        String[] imports =
                new String[] {
                        ...
                        Iterator.class.getCanonicalName(), GwtJacksonSerializers.class.getCanonicalName(),
                        SerializationContext.class.getCanonicalName(), Serializer.class.getCanonicalName()};
     ...
     */
    private String generateSerializer(SourceWriter srcWriter, JClassType type, GwtJacksonSerialize annotation) {
    ...
    private void generateConstructor(SourceWriter srcWriter, ArrayList<String> serializers) {
        srcWriter.println("public GwtJacksonSerializersImpl() {");
