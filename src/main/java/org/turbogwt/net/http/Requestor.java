 ...
 * <p/>
 *
 * You can register custom {@link org.turbogwt.net.http.serialization.Serializer} with #registerSerializer.
 * The same for {@link org.turbogwt.net.http.serialization.Deserializer}.
 * If you want to support both serialization and deserialization for your custom object,
 * register a {@link org.turbogwt.net.http.serialization.Serdes} with #registerSerdes.
 * <p/>
 *
...
public class Requestor {
     ...
     *
     * @see org.turbogwt.net.http.ListAsyncCallback
     * @see org.turbogwt.net.http.SetAsyncCallback
     *
     * @param uri               The uri for the request.
     * @param responseType      The class of the response type.
